...
#### Semantic ranker results in hybrid queries
...
If you're using semantic ranking in previous APIs, set "k" to 50, to ensure that the semantic ranker gets at least 50 results. Setting "top" does not affect the input to semantic ranker.
